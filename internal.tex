...
NVMeVirt is a software-defined NVMe device implemented as a Linux kernel module, providing the capability to emulate various storage devices using the existing NVMe interface.
